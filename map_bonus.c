...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/03 01:13:00 by srachdi           #+#    #+#             */
/*   Updated: 2023/01/03 04:32:57 by srachdi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	checkmap(t_game *game)
{
	if (checkmapstring(game))
		exitmap(game, "map must contain : 1 "
			"player,1 exit,and at least one collectible");
	if (checkstrangechar(game->map_string, "01PECx"))
