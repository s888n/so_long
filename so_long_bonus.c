...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/03 01:14:24 by srachdi           #+#    #+#             */
/*   Updated: 2023/01/03 01:14:27 by srachdi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	initgame(t_game *game, char *map)
{
	...
	game->win = mlx_new_window(game->mlx,
			game->width * IMAGE_SIZE, game->height * IMAGE_SIZE, "./so_long");
	if (!game->win)
...
int	main(int ac, char *av[])
{
	...
	mlx_hook(game->win, 3, 0, release, game);
